/*
 * bwc.c - generator and parser of BWC message
 *
...
navierr_status_t navi_init_bwc(struct bwc_t *msg, navi_talkerid_t tid)
{
	assert(msg != NULL);
...
//
// Creates BWC message
navierr_status_t navi_create_bwc(const struct bwc_t *msg, char *buffer,
...
//
// Parses BWC message
navierr_status_t navi_parse_bwc(struct bwc_t *msg, char *buffer)
{
	size_t i = 0, nmread;
