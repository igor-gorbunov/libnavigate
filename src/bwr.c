/*
 * bwr.c - generator and parser of BWR message
 *
...
navierr_status_t navi_init_bwr(struct bwr_t *msg, navi_talkerid_t tid)
{
	assert(msg != NULL);
...
//
// Creates BWR message
navierr_status_t navi_create_bwr(const struct bwr_t *msg, char *buffer,
...
//
// Parses BWR message
navierr_status_t navi_parse_bwr(struct bwr_t *msg, char *buffer)
{
	size_t i = 0, nmread;
